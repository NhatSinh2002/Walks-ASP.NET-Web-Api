...
namespace WalksAPI.Migrations
{
    ...
    [Migration("20240520092656_Seeding Data for Difficulties and Regions")]
            ...
            modelBuilder.Entity("WalksAPI.Models.Domain.Difficulty", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("5d2323e0-bfb7-4290-ac94-9e4a301e858f"),
                            Name = "Easy"
                        },
                        new
                        {
                            Id = new Guid("a1f08453-46a0-4265-9da6-975d34fbeac1"),
                            Name = "Medium"
                        },
                        new
                        {
                            Id = new Guid("507192a1-a769-45af-9ee1-adceb8727a38"),
                            Name = "Hard"
                        });
                });
